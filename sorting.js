...
const stringsToNumbs = (arr) => arr.map(x => parseInt(x));
const newArray = stringsToNumbs(strNums);
console.log(newArray)
console.log(stringsToNumbs(strNums))


const even = newArray.filter(number => {
  return number % 2 === 0;
});
console.log(even)

const initialValue = 0;
const sum = even.reduce(
...
const weatherStates = (array) => {
  const weatherStateNames = [];
  array.forEach(state => {
    weatherStateNames.push(state.weather_state_name);
    // console.log(weatherStateNames);
  })
